...
REPO="https://raw.githubusercontent.com/Floriano21/scriptvps/main/"
...
function install_xray() {
    ...
    wget -O /usr/bin/xray/xray "https://github.com/bezzo9699/Autoscript-vps/raw/main/Core_Xray_MOD/xray.linux.64bit" >/dev/null 2>&1
